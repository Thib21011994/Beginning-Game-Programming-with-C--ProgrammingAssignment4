...
namespace ProgrammingAssignment4
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            pickupSprite = Content.Load<Texture2D>(@"bin\Windows\graphics\pickup");            

            // STUDENTS: create teddy object centered in window
            Vector2 centerLocation;
            centerLocation.X = WindowWidth / 2;
            centerLocation.Y = WindowHeight / 2;
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            else if (mouse.RightButton == ButtonState.Released)
            {
                ...
                if (rightClickStarted)
                {
                    ...
                    pickUpLocation.X = mouse.X;
                    pickUpLocation.Y = mouse.Y;
                ...
                teddy.CollisionRectangle.Intersects(pickups[0].CollisionRectangle))
            {
                ...
                if (pickups.Count > 0)
                {
                    ...
                    targetLocation.X = pickups[0].CollisionRectangle.X;
                    targetLocation.Y = pickups[0].CollisionRectangle.Y;                    
                    teddy.SetTarget(targetLocation);
                }
                else
                {
                    teddy.ClearTarget();
